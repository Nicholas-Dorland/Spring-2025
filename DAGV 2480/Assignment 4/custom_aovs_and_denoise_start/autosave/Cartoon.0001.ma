...
//Last modified: Tue, Apr 01, 2025 12:53:03 PM
//Codeset: 1252
...
fileInfo "UUID" "DDB56E64-4BDB-748F-CB65-35B32A798990";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1E06C577-4713-68F9-901C-6CB6FF05EA33";
	setAttr -s 54 ".lnk";
	setAttr -s 54 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "051ABAFB-4F0D-449F-C9D3-7FBB68D31FD9";
	setAttr ".cdl" 2;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B0D57A7E-42B8-55AE-05A0-5593B70A8C6A";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C0CC102F-4714-1338-238C-21BD3DAEFABD";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EB874957-4FE4-C5B3-73AD-54B4AE62BE3B";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "15DD0D2B-4676-0BF7-255F-B4AB80653885";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -369.04760438298484 -344.72584912401857 ;
	setAttr ".tgi[0].vh" -type "double2" 361.90474752395943 398.29727556670997 ;
	setAttr -s 2 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -254.28572082519531;
	setAttr ".tgi[0].ni[0].y" 148.57142639160156;
	setAttr ".tgi[0].ni[0].nvs" 1923;
